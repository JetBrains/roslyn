...
namespace Microsoft.CodeAnalysis.Host.Mef
{
    ...
    public class ExportLanguageServiceFactoryAttribute(Type type, string language, string layer = ServiceLayer.Default) : ExportAttribute(typeof(ILanguageServiceFactory))
    {
        /// <summary>
