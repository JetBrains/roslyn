...
#pragma warning disable CA1200 // Avoid using cref tags with a prefix - The prefix is required since this file is referenced in projects that can't access syntax nodes
    ...
    {
        None = 0,
        List = 1, // JetHack: we replace GreenNode.ListKind because this file is used in CSharpSyntaxGenerator.csproj that does not have reference to Microsoft.CodeAnalysis
