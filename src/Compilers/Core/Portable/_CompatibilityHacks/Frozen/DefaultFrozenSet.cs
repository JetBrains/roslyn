...
{
    /// <summary>Provides the default <see cref="FrozenSet4Hack{T}"/> implementation to use when no other special-cases apply.</summary>
    ...
    internal sealed class DefaultFrozenSet<T> : ItemsFrozenSet<T, DefaultFrozenSet<T>.GSW>
    {
        ...
        internal struct GSW : IGenericSpecializedWrapper
        {
            ...
            public void Store(FrozenSet4Hack<T> set) => _set = (DefaultFrozenSet<T>)set;
