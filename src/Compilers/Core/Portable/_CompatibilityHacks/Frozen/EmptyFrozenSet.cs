...
{
    /// <summary>Provides an empty <see cref="FrozenSet4Hack{T}"/> to use when there are zero values to be stored.</summary>
    internal sealed class EmptyFrozenSet<T> : FrozenSet4Hack<T>
    {
