...
{
    /// <summary>Provides a <see cref="FrozenSet4Hack{T}"/> implementation to use with small item counts.</summary>
    ...
    internal sealed class SmallFrozenSet<T> : FrozenSetInternalBase<T, SmallFrozenSet<T>.GSW>
    {
        ...
        internal struct GSW : IGenericSpecializedWrapper
        {
            ...
            public void Store(FrozenSet4Hack<T> set) => _set = (SmallFrozenSet<T>)set;
