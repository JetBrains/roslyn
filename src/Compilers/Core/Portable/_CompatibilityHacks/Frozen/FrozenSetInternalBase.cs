...
namespace System.Collections.Frozen
{
    ...
    /// </typeparam>
    internal abstract class FrozenSetInternalBase<T, TThisWrapper> : FrozenSet4Hack<T>
        where TThisWrapper : struct, FrozenSetInternalBase<T, TThisWrapper>.IGenericSpecializedWrapper
    {
        ...
        private protected override bool IsProperSubsetOfCore(IEnumerable<T> other)
        {
            ...
            var kvp = CheckUniqueAndUnfoundElements(other, returnIfUnfound: false);
            return kvp.Key == _thisSet.Count && kvp.Value > 0;
        }
        ...
        private protected override bool IsProperSupersetOfCore(IEnumerable<T> other)
        {
            ...
            // We couldn't take a fast path; do the full comparison.
            var kvp = CheckUniqueAndUnfoundElements(other, returnIfUnfound: true);
            return kvp.Key < _thisSet.Count && kvp.Value == 0;
        }
        ...
        private bool ComparersAreCompatible(IReadOnlySet<T> other) =>
            other switch
            {
                ...
                FrozenSet4Hack<T> fs => _thisSet.Comparer.Equals(fs.Comparer),
                _ => false
            };
        ...
        {
            void Store(FrozenSet4Hack<T> @this);
            int Count { get; }
